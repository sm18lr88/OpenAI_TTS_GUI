...
layout = [
    ...
    [sg.Text("Token Count: "), sg.Text("0", size=(15, 1), key="token_count"), sg.Text("Character Count: "), sg.Text("0", size=(15, 1), key="char_count")],
...
while True:
    ...
    if event == 'text_box':  
        ...
        token_count, char_count = count_tokens_and_characters(text)
        if token_count is not None and char_count is not None:
            ...
            sg.popup_error("Failed to count tokens and characters. Check the log for errors.")
